<?php 
    $dir_func = __DIR__;
    $parentdir_func = dirname(dirname($dir_func));

    require_once($parentdir_func ."/connection/dependencies.php");
    ...
    function get_avatars() {
        $directory = "../../type_master/assets/avatars"; // Replace with the path to your directory
