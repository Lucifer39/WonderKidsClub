...
DROP TABLE IF EXISTS vocab_context;

CREATE TABLE vocab_context (
  id int NOT NULL AUTO_INCREMENT,
  context_name varchar(255) DEFAULT NULL,
  banner_img varchar(255) DEFAULT NULL,
  context_title varchar(255) DEFAULT NULL,
  context_subtitle varchar(255) DEFAULT NULL,
  context_description longtext,
...
--
-- Dumping data for table `vocab_context`
--

INSERT INTO vocab_context VALUES (1,'Christmas Context','christmas_banner.jpg','Christmas','Celebrating the joyous season','Christmas is a time for joy, love, and togetherness. It is a special holiday that brings families and friends together to celebrate and exchange gifts. The holiday is often associated with traditions such as decorating Christmas trees, singing carols, and enjoying delicious meals.','2023-06-30 13:08:54',2);
INSERT INTO vocab_context VALUES (2,'Harry Potter Spells Context','harry_potter_spells_banner.jpg','harry potter spells','Unleashing the magic within','Step into the enchanting world of Harry Potter and experience the thrill of casting spells. From the famous \"Expelliarmus\" to the powerful \"Avada Kedavra,\" explore the vast array of magical incantations that bring the wizarding world to life. Learn the wand movements and pronunciation to master these spells.','2023-06-30 13:08:55',1);
INSERT INTO vocab_context VALUES (3,'Alternatives of Very Context','alternatives_of_very_banner.jpg','alternatives of very','Expanding your vocabulary','Are you tired of using the word \"very\" repeatedly in your writing? Discover a range of alternatives that can enhance your language and make your sentences more descriptive. Explore words like \"extremely,\" \"exceedingly,\" \"exceptionally,\" and more to express intensity and add depth to your expression.','2023-06-30 13:08:55',3);
INSERT INTO vocab_context VALUES (4,'Where the Wild Things Are','books.jpg','WHERE THE WILD THINGS ARE','Maurice Sendak','Where the Wild Things Are is a beloved children\'s book written by Maurice Sendak. It tells the story of a young boy named Max who embarks on a wild adventure with a group of imaginative creatures known as the Wild Things.','2023-07-03 22:36:17',1);
INSERT INTO vocab_context VALUES (5,'The Giving Tree','books.jpg','THE GIVING TREE','Shel Silverstein','The Giving Tree is a heartwarming tale written by Shel Silverstein. It explores the selfless love and generosity of a tree towards a boy throughout his life. The book beautifully depicts the themes of friendship, sacrifice, and the cycle of life.','2023-07-03 22:36:18',1);
INSERT INTO vocab_context VALUES (6,'Charlotte\'s Web','books.jpg','CHARLOTTE\'S WEB','E.B. White','Charlotte\'s Web is a classic children\'s novel written by E.B. White. It tells the story of a pig named Wilbur and his friendship with a clever spider named Charlotte. The book explores themes of friendship, loyalty, and the circle of life.','2023-07-03 22:36:18',1);
INSERT INTO vocab_context VALUES (7,'The Lion, the Witch, and the Wardrobe','books.jpg','THE LION, THE WITCH, AND THE WARDROBE','C.S. Lewis','The Lion, the Witch, and the Wardrobe is the first book in the Chronicles of Narnia series by C.S. Lewis. It follows the adventures of four siblings who discover a magical wardrobe that leads them to the enchanting world of Narnia. The book is filled with fantasy, adventure, and themes of good versus evil.','2023-07-03 22:36:18',1);
INSERT INTO vocab_context VALUES (8,'Matilda','books.jpg','MATILDA','Roald Dahl','Matilda is a beloved children\'s novel written by Roald Dahl. It tells the story of a brilliant young girl named Matilda who possesses extraordinary intelligence and magical powers. The book celebrates the power of imagination, the love for books, and the triumph of good over evil.','2023-07-03 22:36:18',1);
INSERT INTO vocab_context VALUES (9,'The Very Hungry Caterpillar','books.jpg','THE VERY HUNGRY CATERPILLAR','Eric Carle','The Very Hungry Caterpillar is a popular children\'s picture book written by Eric Carle. It follows the journey of a hungry caterpillar as it eats its way through various food items before transforming into a beautiful butterfly. The book teaches children about counting, the days of the week, and the life cycle of a butterfly.','2023-07-03 22:36:18',1);
INSERT INTO vocab_context VALUES (10,'Goodnight Moon','books.jpg','GOODNIGHT MOON','Margaret Wise Brown','Goodnight Moon is a classic bedtime story written by Margaret Wise Brown. It takes young readers on a soothing journey as they say goodnight to various objects and characters in a cozy room. The book is known for its calming rhythm and gentle illustrations.','2023-07-03 22:36:18',1);
INSERT INTO vocab_context VALUES (11,'Oh, the Places You\'ll Go!','books.jpg','OH, THE PLACES YOU\'LL GO!','Dr. Seuss','Oh, the Places You\'ll Go! is a popular children\'s book written by Dr. Seuss. It is a whimsical and inspirational story that encourages readers to embrace life\'s adventures, overcome challenges, and reach for their dreams. The book has become a popular gift for graduations and other milestones.','2023-07-03 22:36:40',1);
INSERT INTO vocab_context VALUES (12,'The Tale of Peter Rabbit','books.jpg','THE TALE OF PETER RABBIT','Beatrix Potter','The Tale of Peter Rabbit is a classic children\'s book written and illustrated by Beatrix Potter. It follows the mischievous adventures of a young rabbit named Peter as he disobeys his mother\'s warnings and ventures into Mr. McGregor\'s garden. The book is known for its charming illustrations and timeless storytelling.','2023-07-03 22:36:40',1);
INSERT INTO vocab_context VALUES (13,'Harry Potter and the Sorcerer\'s Stone','harry_potter_spells_banner.jpg','HARRY POTTER AND THE SORCERER\'S STONE','J.K. Rowling','Harry Potter and the Sorcerer\'s Stone is the first book in the iconic Harry Potter series written by J.K. Rowling. It introduces readers to the magical world of Hogwarts School of Witchcraft and Wizardry and follows Harry Potter\'s journey as he discovers his true identity, battles dark forces, and learns the power of friendship and bravery.','2023-07-03 22:36:40',1);
INSERT INTO vocab_context VALUES (14,'The Gruffalo','books.jpg','THE GRUFFALO','Julia Donaldson','The Gruffalo is a beloved children\'s picture book written by Julia Donaldson and illustrated by Axel Scheffler. It tells the story of a clever little mouse who outwits various forest creatures by inventing a fearsome creature called the Gruffalo. The book celebrates wit, bravery, and the importance of using one\'s imagination.','2023-07-03 22:36:40',1);
INSERT INTO vocab_context VALUES (15,'Corduroy','books.jpg','CORDUROY','Don Freeman','Corduroy is a classic children\'s book written and illustrated by Don Freeman. It follows the adventures of a small teddy bear named Corduroy who lives in a department store. The book teaches children about friendship, kindness, and the value of being oneself.','2023-07-03 22:36:40',1);
INSERT INTO vocab_context VALUES (16,'Winnie-the-Pooh','books.jpg','WINNIE-THE-POOH','A.A. Milne','Winnie-the-Pooh is a collection of stories written by A.A. Milne. The book introduces readers to the lovable bear named Winnie-the-Pooh and his friends in the Hundred Acre Wood, including Piglet, Tigger, Eeyore, and Rabbit. The stories capture the essence of friendship, imagination, and simple joys.','2023-07-03 22:36:40',1);
INSERT INTO vocab_context VALUES (17,'The Little Prince','books.jpg','THE LITTLE PRINCE','Antoine de Saint-Exupéry','The Little Prince is a philosophical novella written by Antoine de Saint-Exupéry. It tells the story of a young prince who travels from planet to planet, meeting various unique characters and gaining wisdom about life, love, and human nature. The book explores themes of innocence, imagination, and the importance of seeing beyond the surface.','2023-07-03 22:36:58',1);
INSERT INTO vocab_context VALUES (18,'The BFG','books.jpg','THE BFG','Roald Dahl','The BFG (short for Big Friendly Giant) is a children\'s book written by Roald Dahl. It follows the adventures of a young girl named Sophie who befriends a kind-hearted giant and together they set out to stop other evil giants from eating children. The book is filled with Dahl\'s signature wit, imagination, and memorable characters.','2023-07-03 22:36:58',1);
INSERT INTO vocab_context VALUES (19,'The Chronicles of Narnia','books.jpg','THE CHRONICLES OF NARNIA','C.S. Lewis','The Chronicles of Narnia is a series of fantasy novels written by C.S. Lewis. The books take readers on a journey to the magical world of Narnia, where they encounter talking animals, mythical creatures, and epic battles between good and evil. The series is beloved for its rich world-building, memorable characters, and profound themes.','2023-07-03 22:36:58',1);
INSERT INTO vocab_context VALUES (20,'Charlie and the Chocolate Factory','books.jpg','CHARLIE AND THE CHOCOLATE FACTORY','Roald Dahl','Charlie and the Chocolate Factory is a beloved children\'s book written by Roald Dahl. It tells the story of Charlie Bucket, a young boy who wins a golden ticket to tour the mysterious and magical chocolate factory owned by the eccentric Willy Wonka. The book is a delightful blend of imagination, humor, and moral lessons.','2023-07-03 22:36:58',1);
INSERT INTO vocab_context VALUES (21,'Diary of a Wimpy Kid','books.jpg','DIARY OF A WIMPY KID','Jeff Kinney','Diary of a Wimpy Kid is a humorous children\'s book series written and illustrated by Jeff Kinney. The books are presented as the diary entries of Greg Heffley, a middle-school student navigating the ups and downs of adolescence. The series combines relatable humor, illustrations, and themes of friendship and growing up.','2023-07-03 22:36:58',1);
INSERT INTO vocab_context VALUES (22,'Alice\'s Adventures in Wonderland','books.jpg','ALICE\'S ADVENTURES IN WONDERLAND','Lewis Carroll','Alice\'s Adventures in Wonderland is a classic novel written by Lewis Carroll. It follows the journey of Alice, a young girl who falls down a rabbit hole into a whimsical and nonsensical world filled with peculiar characters. The book is known for its imaginative storytelling, wordplay, and satirical commentary on Victorian society.','2023-07-03 22:36:58',1);
INSERT INTO vocab_context VALUES (23,'The Secret Garden','books.jpg','THE SECRET GARDEN','Frances Hodgson Burnett','The Secret Garden is a classic children\'s novel written by Frances Hodgson Burnett. It tells the story of Mary Lennox, a young girl who discovers a hidden garden within the grounds of her uncle\'s mansion. As she tends to the neglected garden, Mary\'s own transformation begins, as does the healing of those around her. The book explores themes of nature, healing, and the power of friendship and love.','2023-07-03 22:37:09',1);
INSERT INTO vocab_context VALUES (24,'Adjectives for A','adjectives.jpg','A','Discover Adjectives starting with the letter A','Adjectives that describe nouns starting with the letter A.','2023-07-05 12:57:17',4);
INSERT INTO vocab_context VALUES (25,'Adjectives for B','adjectives.jpg','B','Discover Adjectives starting with the letter B','Adjectives that describe nouns starting with the letter B.','2023-07-05 12:57:18',4);
INSERT INTO vocab_context VALUES (26,'Adjectives for C','adjectives.jpg','C','Discover Adjectives starting with the letter C','Adjectives that describe nouns starting with the letter C.','2023-07-05 12:57:18',4);
INSERT INTO vocab_context VALUES (27,'Adjectives for D','adjectives.jpg','D','Discover Adjectives starting with the letter D','Adjectives that describe nouns starting with the letter D.','2023-07-05 12:57:18',4);
INSERT INTO vocab_context VALUES (28,'Adjectives for E','adjectives.jpg','E','Discover Adjectives starting with the letter E','Adjectives that describe nouns starting with the letter E.','2023-07-05 12:57:18',4);
INSERT INTO vocab_context VALUES (29,'Adjectives for F','adjectives.jpg','F','Discover Adjectives starting with the letter F','Adjectives that describe nouns starting with the letter F.','2023-07-05 12:57:18',4);
INSERT INTO vocab_context VALUES (30,'Adjectives for G','adjectives.jpg','G','Discover Adjectives starting with the letter G','Adjectives that describe nouns starting with the letter G.','2023-07-05 12:57:18',4);
INSERT INTO vocab_context VALUES (31,'Adjectives for H','adjectives.jpg','H','Discover Adjectives starting with the letter H','Adjectives that describe nouns starting with the letter H.','2023-07-05 12:57:18',4);
INSERT INTO vocab_context VALUES (32,'Adjectives for I','adjectives.jpg','I','Discover Adjectives starting with the letter I','Adjectives that describe nouns starting with the letter I.','2023-07-05 12:57:18',4);
INSERT INTO vocab_context VALUES (33,'Adjectives for J','adjectives.jpg','J','Discover Adjectives starting with the letter J','Adjectives that describe nouns starting with the letter J.','2023-07-05 12:57:18',4);
INSERT INTO vocab_context VALUES (34,'Adjectives for K','adjectives.jpg','K','Discover Adjectives starting with the letter K','Adjectives that describe nouns starting with the letter K.','2023-07-05 12:57:18',4);
INSERT INTO vocab_context VALUES (35,'Adjectives for L','adjectives.jpg','L','Discover Adjectives starting with the letter L','Adjectives that describe nouns starting with the letter L.','2023-07-05 12:57:18',4);
INSERT INTO vocab_context VALUES (36,'Adjectives for M','adjectives.jpg','M','Discover Adjectives starting with the letter M','Adjectives that describe nouns starting with the letter M.','2023-07-05 12:57:18',4);
INSERT INTO vocab_context VALUES (37,'Adjectives for N','adjectives.jpg','N','Discover Adjectives starting with the letter N','Adjectives that describe nouns starting with the letter N.','2023-07-05 12:57:18',4);
INSERT INTO vocab_context VALUES (38,'Adjectives for O','adjectives.jpg','O','Discover Adjectives starting with the letter O','Adjectives that describe nouns starting with the letter O.','2023-07-05 12:57:18',4);
INSERT INTO vocab_context VALUES (39,'Adjectives for P','adjectives.jpg','P','Discover Adjectives starting with the letter P','Adjectives that describe nouns starting with the letter P.','2023-07-05 12:57:18',4);
INSERT INTO vocab_context VALUES (40,'Adjectives for Q','adjectives.jpg','Q','Discover Adjectives starting with the letter Q','Adjectives that describe nouns starting with the letter Q.','2023-07-05 12:57:18',4);
INSERT INTO vocab_context VALUES (41,'Adjectives for R','adjectives.jpg','R','Discover Adjectives starting with the letter R','Adjectives that describe nouns starting with the letter R.','2023-07-05 12:57:18',4);
INSERT INTO vocab_context VALUES (42,'Adjectives for S','adjectives.jpg','S','Discover Adjectives starting with the letter S','Adjectives that describe nouns starting with the letter S.','2023-07-05 12:57:18',4);
INSERT INTO vocab_context VALUES (43,'Adjectives for T','adjectives.jpg','T','Discover Adjectives starting with the letter T','Adjectives that describe nouns starting with the letter T.','2023-07-05 12:57:18',4);
INSERT INTO vocab_context VALUES (44,'Adjectives for U','adjectives.jpg','U','Discover Adjectives starting with the letter U','Adjectives that describe nouns starting with the letter U.','2023-07-05 12:57:18',4);
INSERT INTO vocab_context VALUES (45,'Adjectives for V','adjectives.jpg','V','Discover Adjectives starting with the letter V','Adjectives that describe nouns starting with the letter V.','2023-07-05 12:57:18',4);
INSERT INTO vocab_context VALUES (46,'Adjectives for W','adjectives.jpg','W','Discover Adjectives starting with the letter W','Adjectives that describe nouns starting with the letter W.','2023-07-05 12:57:18',4);
INSERT INTO vocab_context VALUES (47,'Adjectives for X','adjectives.jpg','X','Discover Adjectives starting with the letter X','Adjectives that describe nouns starting with the letter X.','2023-07-05 12:57:18',4);
INSERT INTO vocab_context VALUES (48,'Adjectives for Y','adjectives.jpg','Y','Discover Adjectives starting with the letter Y','Adjectives that describe nouns starting with the letter Y.','2023-07-05 12:57:18',4);
INSERT INTO vocab_context VALUES (49,'Adjectives for Z','adjectives.jpg','Z','Discover Adjectives starting with the letter Z','Adjectives that describe nouns starting with the letter Z.','2023-07-05 12:57:18',4);

--
-- Table structure for table `vocab_context_categories`
--

DROP TABLE IF EXISTS vocab_context_categories;

CREATE TABLE vocab_context_categories (
  id int NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `vocab_context_categories`
--

INSERT INTO vocab_context_categories VALUES (1,'Books');
INSERT INTO vocab_context_categories VALUES (2,'Special Days');
INSERT INTO vocab_context_categories VALUES (3,'Alternatives');
INSERT INTO vocab_context_categories VALUES (4,'Adjectives By Alphabets');

--
-- Table structure for table `vocab_context_table`
--

DROP TABLE IF EXISTS vocab_context_table;

CREATE TABLE vocab_context_table (
  id int NOT NULL AUTO_INCREMENT,
  content mediumtext,
  meaning longtext,
  example longtext,
...
--
-- Dumping data for table `vocab_context_table`
--
