                        ...
                        while($getRankingRow = mysqli_fetch_assoc($getRankingSQL)) {
                            ?>
                                <li class="<?php echo $getRankingRow['user_id'] == $_SESSION['id'] ? "selected" : ""; ?>">
                                    <div class="data pe-0">
                                        <img class="featured" src="<?php echo isset($getRankingRow["avatar"]) ? $baseurl . "assets/images/avatars/" . $getRankingRow["avatar"] : "assets/images/profile.jpg" ?>" width="50" height="50" alt="">
                                    </div>
                                    <div class="data w-100 text-center">
                                    ...
                                    <div class="data text-center">
                                        <div class="font17"><?php echo $getRankingRow['score'] ?? 100; ?></div>
                                        <div class="font13 txt-grey">Score</div>
                                    </div>
                                    <div class="data text-center flex-1">
                                        <div class="font17"><?php echo $getRankingRow['ranking'] ?? 1; ?></div>
