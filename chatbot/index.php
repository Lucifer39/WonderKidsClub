<?php 
    ...
    // require_once($parentdir . "/vaultboard_module/connection/dependencies.php");
    require_once("functions/chatbot_functions.php");


    // $current_student = m;
    $current_student_sql = mysqli_query($conn, "SELECT * FROM users WHERE id = '" . $_SESSION["id"] . "'");
    $current_student = mysqli_fetch_assoc($current_student_sql);

    // var_dump($current_student);
    $student_progress = get_user_profile_progress($_SESSION["id"]);
    $incompleteAdjectives = getIncompleteAdjectives($_SESSION["id"]);
?>
...
<div class="chatbot-container">
    <div class="chatbot-content" id="chatbot-container">
        ...
        <div class="chatbot-footer desktop-none" id="chatbot-footer">ⓘ Click once for meaning, twice to select</div>
...
<script src="chatbot.js?v=<?php echo $cacheBust; ?>"></script>
