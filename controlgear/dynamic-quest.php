...
if ( isset( $_POST[ 'submit' ] ) ) {
	...
	// -- end dipanjan changes
		...
		header( 'location:' . $baseurl . 'controlgear/dynamic-quest?message=success' );
		exit;	
	} else {
...
if ( isset( $_GET[ 'message' ] ) && $_GET[ 'message' ] == 'success' ) {
	$errMsg = '<div class="alert alert-success" role="alert">Successfully Saved.</div>';
	echo "<script>window.history.pushState('','','" . $baseurl . "controlgear/dynamic-quest');</script>";
				...
				<form id="myForm" action="" method="post" enctype="multipart/form-data">
					<div class="row">
						<div class="col-md-12 form-group">
							...
							<select name="clsName" id="clsName" onChange="selectClass()" class="custom-select form-control">
						...
						<div id="displaySubject" class="col-md-12 form-group"></div>
						<div id="displayTopic" class="col-md-12 form-group"></div>
						<div id="displaySubTopic" class="col-md-12 form-group"></div>
						<div id="displayloop" class="col-md-12 form-group hide">
						<label class="label mb-1">Question (Loop) <span class="required">*</span></label>
							<input type="text" name="loopval" class="form-control" value="50">
						</div>
						<div class="col-md-12">
...
<?php 	$tpcqury = mysqli_query($conn, "SELECT id,topic FROM topics_subtopics WHERE class_id='".$classRow['id']."' and parent=0 and status=1");
