<?php 
    if(in_array($sbtpName, array('233', '232'))){
        $question_str = array(
            // array(
            //     "type" => "less",
            //     "str" => "How much less units were produced in %%month%% than the remaining months altogether?",
            // ),
            // array(
            //     "type" => "less",
        ...
        $random_ques = rand(0, count($question_str) - 1);
        $set_question = $question_str[$random_ques];
