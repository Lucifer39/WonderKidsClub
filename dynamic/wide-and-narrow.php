<?php
if($sbtpName == '16' || $sbtpName == '20' || $sbtpName == '263') {
    $bftaft = rand($before,$after);
    //Fewer Objects
    if($bftaft == '0') {
        
        $quest_1 = '2';
        $question = "Which of the following is the narrowest?";
        $correct = $quest_1;

        $total = range(2,5);
        $exclude = range(2,$quest_1);
    ...
    if($bftaft == '1') {
        ...
        $quest_1 = '5';
        $question = "Which of the following is the widest?";
        $correct = $quest_1;

        $total = range(2,5);
        $exclude = range(5,$quest_1);
