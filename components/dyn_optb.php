...
if($querow['type2'] != 'p1' && $querow['type2'] != 'q1') {
    ...
    //Long and Short
    } elseif($sbtpcrow['id'] == '14' || $sbtpcrow['id'] == '18' ) { $rndLS = mt_rand(21, 25); $plus = $querow['opt_b']*$rndLS;
        echo "<img class='max-img-width' src='".$baseurl1.$_SESSION['long_short_1']."' style='width:".$plus."px;object-fit: fill'>";
    //Tall and Short
    } elseif($sbtpcrow['id'] == '15' || $sbtpcrow['id'] == '19' ) { $rndLS = mt_rand(21,25); $plus = $querow['opt_b']*$rndLS;
        echo "<img src='".$baseurl1.$_SESSION['tall_short_1']."' style='width:auto;object-fit: contain;height:".$plus."px'>";
    } elseif($sbtpcrow['id'] == '16' || $sbtpcrow['id'] == '20' ) { $plus = $querow['opt_b']*20;
        ...
        echo "<img class='max-img-size' src='".$baseurl1.$_SESSION['light_heavy_2']."' style='height:150px;object-fit:contain'>";
    } elseif($sbtpcrow['id'] == '22') {
        echo numberToWord($querow['opt_b']);
    } elseif($sbtpcrow['id'] == '24' || $sbtpcrow['id'] == '27') {
        echo "<img class='max-img-size' src='".$baseurl1.$_SESSION['shape_2']."' style='height:150px;max-width:150px;object-fit:contain'>";
    ...
    || $sbtpcrow['id'] == '205' 
    || $sbtpcrow['id'] == '206') {
        foreach ($_SESSION['shape_2'] as $filename) {
        ...
        ?>
            <div class="container-dip">
                <canvas id="fractionCanvas-optb-<?php echo $randomString; ?>" width="<?php echo $width; ?>" height="60"></canvas>
            </div>
            <script>
                var canvas_optb = document.getElementById('fractionCanvas-optb-<?php echo $randomString; ?>');
                var ctx_optb = canvas_optb.getContext('2d');
                var fractionsInput_optb = <?php echo json_encode($querow['opt_b']) ?>;
