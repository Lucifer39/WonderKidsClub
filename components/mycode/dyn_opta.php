...
//Long and Short
} elseif($sbtpcrow['id'] == '14' || $sbtpcrow['id'] == '18') { $plus = $querow['opt_a']*40;
    echo "<img src='".$baseurl.$_SESSION['long_short_1']."' style='width:100px;height:".$plus."px'>";
//Tall and Short
} elseif($sbtpcrow['id'] == '15' || $sbtpcrow['id'] == '19') { $plus = $querow['opt_a']*40;
    ...
    echo "<img class='max-img-size' src='".$baseurl.$_SESSION['light_heavy_1']."' style='height:150px;max-width:250px;object-fit:contain'>";
} elseif($sbtpcrow['id'] == '22') {
    echo numberToWord($querow['opt_a']);
} elseif($sbtpcrow['id'] == '24' || $sbtpcrow['id'] == '27') {
    echo "<img class='max-img-size' src='".$baseurl.$_SESSION['shape_1']."' style='height:150px;max-width:150px;object-fit:contain'>";
